...
<body>
    <div class="title">
        <span>SEE Eligibility Check</span>
    </div>
    ...
    <div class="main">
        <div class="login">
            <form action="" method="post" name="login">
                <fieldset>
                    ...
                    <input type="text" name="userid" placeholder="Name" autocomplete="off">
                    <input type="password" name="password" placeholder="USN" autocomplete="off">
        ...
        <div class="search">
            <form action="./student.php" method="get">
                <fieldset>
                    <legend class="heading">Results</legend>
